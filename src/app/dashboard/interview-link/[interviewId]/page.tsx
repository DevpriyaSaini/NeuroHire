 ...
 async function Linkpage({ params }: PageProps) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="flex-1 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 -mt-6 md:ml-30">
                    ...
                    <div className="space-y-4 max-h-[32rem] overflow-y-auto pr-2 custom-scrollbar">
                      {conversation.map((msg, index) => (
                        ...
                        >
                          ...
                          <p className="mt-1 text-gray-800 dark:text-gray-200">{msg.transcript}</p>
                        </div>
                      ))}
                    </div>
                  ) : (
                    <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-8 text-center border border-gray-200 dark:border-gray-600">
                    ...
                    <div className="space-y-6">
                      ...
                      {feedback.feedback?.rating && (
                        <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                          <h3 className="font-medium mb-3 text-gray-800 dark:text-white">Performance Ratings</h3>
